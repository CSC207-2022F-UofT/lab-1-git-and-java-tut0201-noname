...
public class IntroLab {
     ...
     */
    public static String guoBilly(String greeting, String name, boolean likes_cats, String message) {
    ...
    public static void main(final String[] args) {
         ...
         */
        System.out.println(guoBilly("Hello", "Billy", true, "I look forward to CSC207!"));
